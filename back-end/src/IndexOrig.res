...
App.patchWithMany(app, ~path="/:id/id", [Middleware.from((next, req) => {
      let previousMiddlewares = list{"middleware0", "middleware1", "middleware2"}
      checkProperties(req, next, previousMiddlewares, res =>
        switch getDictString(Request.params(req), "id") {
        | Some("123") => Response.sendJson(makeSuccessJson(), res)
...
App.putWithMany(app, ~path="/:id/id", [Middleware.from((next, req) => {
      let previousMiddlewares = list{"middleware0", "middleware1", "middleware2"}
      checkProperties(req, next, previousMiddlewares, res =>
        switch getDictString(Request.params(req), "id") {
        | Some("123") => Response.sendJson(makeSuccessJson(), res)
...
App.deleteWithMany(app, ~path="/:id/id", [Middleware.from((next, req) => {
      let previousMiddlewares = list{"middleware0", "middleware1", "middleware2"}
      checkProperties(req, next, previousMiddlewares, res =>
        switch getDictString(Request.params(req), "id") {
        | Some("123") => Response.sendJson(makeSuccessJson(), res)
...
\"@@"(App.get(app, ~path="/baseUrl"), Middleware.from((next, req) =>
...
\"@@"(App.get(app, ~path="/hostname"), Middleware.from((next, req) =>
...
\"@@"(App.get(app, ~path="/ip"), Middleware.from((next, req) =>
...
\"@@"(App.get(app, ~path="/method"), Middleware.from((next, req) =>
...
\"@@"(App.get(app, ~path="/originalUrl"), Middleware.from((next, req) =>
...
\"@@"(App.get(app, ~path="/path"), Middleware.from((next, req) =>
...
\"@@"(App.get(app, ~path="/protocol"), Middleware.from((next, req) =>
...
\"@@"(App.get(app, ~path="/query"), Middleware.from((next, req) =>
...
App.getWithMany(app, ~path="/accepts", [Middleware.from((next, req) =>
...
App.getWithMany(app, ~path="/accepts-charsets", [Middleware.from((next, req) =>
...
\"@@"(App.get(app, ~path="/get"), Middleware.from((next, req) =>
...
\"@@"(App.get(app, ~path="/fresh"), Middleware.from((next, req) =>
...
\"@@"(App.get(app, ~path="/stale"), Middleware.from((next, req) =>
...
\"@@"(App.get(app, ~path="/secure"), Middleware.from((next, req) =>
...
\"@@"(App.get(app, ~path="/xhr"), Middleware.from((next, req) =>
...
\"@@"(
  ...
  Middleware.from(_next =>
    \">>"(\">>"(\">>"(Request.bodyJSON, raiseIfNone), Body.jsonDecoder), req =>
      {"number": req["number"] * 2} |> Body.encoder |> Response.sendJson
    )
  ),
)
...
\"@@"(
  ...
  Middleware.from(_next =>
    \">>"(\">>"(\">>"(Request.bodyURLEncoded, raiseIfNone), Body.urlEncodedDecoder), req =>
      {"number": req["number"] * 2} |> Body.encoder |> Response.sendJson
    )
  ),
)
...
\"@@"(
  ...
  Middleware.from(_next => \">>"(\">>"(Request.bodyText, raiseIfNone), Response.sendString)),
)
